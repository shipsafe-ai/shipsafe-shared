...
## Shared timing skeleton (3:30 / 210s)
| Beat | Time | Purpose |
|---|---|---|
| Crisis hook | 0:00–0:10 | Something breaking, on screen, no narrator |
| The problem | 0:10–0:30 | The pain every team with this system has felt |
| ShipSafe 30s | 0:30–0:55 | Fleet of 6, one command, Hormuz thread |
| This agent + why Gemini | 0:55–1:15 | What it does + the reasoning code can't do |
